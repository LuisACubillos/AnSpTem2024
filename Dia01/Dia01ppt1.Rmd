---
title: "Análisis espaciotemporal: fundamentos"
...
knitr::include_graphics("Figs/01_autocorrelacion_espacial.png")
```
...
Autocorrelación espacial implica efectos endógenos de la variable de interés, i.e.,
...
1.  Modelo de los datos: $[\text{datos}|\text{procesos}, \text{parámetros}]$

2.  Modelo de los procesos: $[\text{procesos}|\text{parámetros}]$

3.  Parámetros del modelo: $[\text{parámetros}]$

## Probabilidad condicional

$$[\text{proceso}, \text{parms}|\text{datos}] \propto [\text{datos}|\text{procesos,parms}] \times [\text{procesos}|\text{parms}] \times [\text{parms}]$$


Al dividir el lado derecho por $[\text{datos}]$, se debe aplicar la regla de probabilidad condicional de Bayes.
